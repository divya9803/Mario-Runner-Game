...
function setup() {
  ...
  ground = createSprite(0,height-10,1200,10);
  ...
  restart = createSprite(300,height/2 + 30);
...
function spawnCoin() {
  ...
  if (frameCount % 60 === 0) {
    var coin = createSprite(600,height - 20,40,10);
    coin.y = Math.round(random(height - 150,height-200));
